  ...
  return (
    <>
      <div className="cCardLayout">
        <div className="row align-items-center gap-md-3 flex-direction-reverse">
          <div className="col-md-6 col px-md-5 py-md-3 cardInput">
          ...
          <div className=" dnone col px-md-5 py-md-3 px-2 py-2">
